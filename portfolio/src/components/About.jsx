      ...
      <div className="relative z-40 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="text-neutral-400 space-y-6">
            ...
            <p className="text-lg leading-relaxed">
              My journey in web development started 4 years ago, and since then, I've worked
              on various projects ranging from e-commerce platforms to AI/ML applications.
            </p>
          </div>
